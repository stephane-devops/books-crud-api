...
export interface AppResourcesConfig {
  ...
  backendSubdomainImport: DataAwsCloudformationExport;
...
export class AppResources extends Construct {
  ...
  constructor(scope: Construct, id: string, config: AppResourcesConfig) {
    ...
    this.customDomainName = `${config.backendSubdomainImport.value}.${config.domainNameImport.value}`;
    ...
    new Route53Record(this, "ApiRoute53Record", {
      ...
      name: config.backendSubdomainImport.value,
      type: "A",
      alias: {
